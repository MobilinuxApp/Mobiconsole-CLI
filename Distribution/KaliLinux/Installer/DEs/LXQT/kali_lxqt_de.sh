...
then
        ...
        then
               echo 'Installing Minimal System '
		           sleep 4
    		       apt-get install lxqt lxqt-core lxqt-config qterminal tigervnc-standalone-server dbus-x11 xfe -y
        fi
        ...
        then
            	echo 'Installing Full System '
		          sleep 4
		          apt-get install lxqt lxqt-core lxqt-config qterminal tigervnc-standalone-server dbus-x11 xfe gimp neofetch libreoffice kali-tools-default -y
