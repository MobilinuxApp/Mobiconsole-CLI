...
wget --tries=20 $dlink/Installer/DEs/LXDE/kali_lxde_de.sh -O $folder/root/kali_lxde_de.sh
clear
...
clear
if [ ! -f /root/kali_lxde_de.sh ]; then
    wget --tries=20 $dlink/Installer/DEs/LXDE/kali_lxde_de.sh -O /root/kali_lxde_de.sh
    bash ~/kali_lxde_de.sh
else
    bash ~/kali_lxde_de.sh
fi
clear
