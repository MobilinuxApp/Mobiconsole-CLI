...
wget --tries=20 $dlink/Installer/DEs/LXQT/kali_lxqt_de.sh -O $folder/root/kali_lxqt_de.sh
clear
...
clear
if [ ! -f /root/kali_lxqt_de.sh ]; then
    wget --tries=20 $dlink/Installer/DEs/LXQT/kali_lxqt_de.sh -O /root/kali_lxqt_de.sh
    bash ~/kali_lxqt_de.sh
else
    bash ~/kali_lxqt_de.sh
fi
clear
if [ ! -f /usr/local/bin/vncserver-start ]; then
    ...
    wget --tries=20 $dlin/Installer/DEs/LXQT/vncserver-stop -O /usr/local/bin/vncserver-stop
