...
wget --tries=20 $dlink/Installer/DEs/MATE/kali_mate_de.sh -O $folder/root/kali_mate_de.sh
clear
...
clear
if [ ! -f /root/kali_mate_de.sh ]; then
    wget --tries=20 $dlink/Installer/DEs/MATE/kali_mate_de.sh -O /root/kali_mate_de.sh
    bash ~/kali_mate_de.sh
else
    bash ~/kali_mate_de.sh
fi
clear
