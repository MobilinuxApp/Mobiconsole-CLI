...
then
		...
		sleep 4
		apt-get install xfe xfce4 xfce4-terminal tightvncserver xfce4-goodies gimp neofetch libreoffice task-xfce-desktop -y
...
mkdir ~/.vnc
wget https://raw.githubusercontent.com/MobilinuxApp/Mobiconsole-CLI/master/Distribution/Debian/Installer/DEs/XFCE4/xstartup -P ~/.vnc/
wget https://raw.githubusercontent.com/MobilinuxApp/Mobiconsole-CLI/master/Distribution/Debian/Installer/DEs/XFCE4/CompatabilityScripts/vncserver-start -P /usr/local/bin/
wget https://raw.githubusercontent.com/MobilinuxApp/Mobiconsole-CLI/master/Distribution/Debian/Installer/DEs/XFCE4/vncserver-stop -P /usr/local/bin/
