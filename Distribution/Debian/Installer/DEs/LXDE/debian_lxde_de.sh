...
then
        ...
        then
            	echo 'Installing Full System '
		          sleep 4
		          apt-get install lxde-core lxterminal tigervnc-standalone-server task-lxde-desktop lxde xfe gimp neofetch libreoffice -y
...
wget https://raw.githubusercontent.com/MobilinuxApp/Mobiconsole-CLI/master/Distribution/Debian/Installer/DEs/LXDE/vncserver-start -P /usr/local/bin/
