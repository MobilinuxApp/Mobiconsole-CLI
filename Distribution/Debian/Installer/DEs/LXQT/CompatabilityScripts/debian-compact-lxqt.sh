...
then
        ...
        then
               echo 'Installing Minimal System '
		           sleep 4
    		       apt-get install lxqt-core lxqt-config qterminal tightvncserver xfe -y
        fi
        ...
        then
            	echo 'Installing Full System '
		          sleep 4
		          apt-get install lxqt-core lxqt-config qterminal tightvncserver xfe gimp neofetch libreoffice task-lxqt-desktop -y
...
mkdir ~/.vnc
wget https://raw.githubusercontent.com/MobilinuxApp/Mobiconsole-CLI/master/Distribution/Debian/Installer/DEs/LXQT/xstartup -P ~/.vnc/
wget https://raw.githubusercontent.com/MobilinuxApp/Mobiconsole-CLI/master/Distribution/Debian/Installer/DEs/LXQT/CompatabilityScripts/vncserver-start -P /usr/local/bin/
wget https://raw.githubusercontent.com/MobilinuxApp/Mobiconsole-CLI/master/Distribution/Debian/Installer/DEs/LXQT/vncserver-stop -P /usr/local/bin/
