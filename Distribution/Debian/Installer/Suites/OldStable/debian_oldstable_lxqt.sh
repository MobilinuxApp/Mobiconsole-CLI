...
wget --tries=20 $dlink/Installer/DEs/LXQT/CompatabilityScripts/debian-compact-lxqt.sh -O $folder/root/debian-compact-lxqt.sh
clear
...
clear
if [ ! -f /root/debian-compact-lxqt.sh ]; then
    wget --tries=20 $dlink/Installer/DEs/LXQT/CompatabilityScripts/debian-compact-lxqt.sh -O /root/debian-compact-lxqt.sh
    bash ~/debian-compact-lxqt.sh
else
    bash ~/debian-compact-lxqt.sh
fi
clear
...
rm -rf /root/debian-compact-lxqt.sh
