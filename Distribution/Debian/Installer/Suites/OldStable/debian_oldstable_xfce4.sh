...
wget --tries=20 $dlink/Installer/DEs/XFCE4/CompatabilityScripts/debian-compact-xfce4.sh -O $folder/root/debian-compact-xfce4.sh
clear
...
clear
if [ ! -f /root/debian-compact-xfce4.sh ]; then
    wget --tries=20 $dlink/Installer/DEs/XFCE4/CompatabilityScripts/debian-compact-xfce4.sh -O /root/debian-compact-xfce4.sh
    bash ~/debian-compact-xfce4.sh
else
    bash ~/debian-compact-xfce4.sh
fi
clear
if [ ! -f /usr/local/bin/vncserver-start ]; then
    wget --tries=20  $dlink/Installer/DEs/XFCE4/CompatabilityScripts/vncserver-start -O /usr/local/bin/vncserver-start
...
rm -rf /root/debian-compact-xfce4.sh
