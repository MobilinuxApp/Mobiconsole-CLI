...
wget --tries=20 $dlink/Installer/DEs/MATE/CompatabilityScripts/debian-compact-mate.sh -O $folder/root/debian-compact-mate.sh
clear
...
if [ ! -f /root/debian_mate_de.sh ]; then
    wget --tries=20 $dlink/Installer/DEs/MATE/CompatabilityScripts/debian-compact-mate.sh -O /root/debian-compact-mate.sh
    bash ~/debian-compact-mate.sh
else
    bash ~/debian-compact-mate.sh
fi
clear
