...
if [ ! -f /usr/local/bin/vncserver-start ]; then
    wget --tries=20  $dlink/Installer/WindowManagers/i3/vncserver-start -O /usr/local/bin/vncserver-start
    wget --tries=20 $dlink/Installer/WindowManagers/i3/vncserver-stop -O /usr/local/bin/vncserver-stop
