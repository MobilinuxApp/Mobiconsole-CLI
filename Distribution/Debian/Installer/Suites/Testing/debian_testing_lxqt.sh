...
wget --tries=20 $dlink/Installer/DEs/LXQT/debian_lxqt_de.sh -O $folder/root/debian_lxqt_de.sh
clear
...
echo "Done! "
clear
if [ ! -f /root/debian_lxqt_de.sh ]; then
    wget --tries=20 $dlink/Installer/DEs/LXQT/debian_lxqt_de.sh -O /root/debian_lxqt_de.sh
    bash ~/debian_lxqt_de.sh
else
    bash ~/debian_lxqt_de.sh
fi
clear
