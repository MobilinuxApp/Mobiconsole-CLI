...
wget --tries=20 $dlink/Installer/DEs/MATE/debian_mate_de.sh -O $folder/root/debian_mate_de.sh
clear
...
echo " "
clear
if [ ! -f /root/debian_mate_de.sh ]; then
    wget --tries=20 $dlink//Installer/DEs/MATE/debian_mate_de.sh -O /root/debian_mate_de.sh
    bash ~/debian_mate_de.sh
else
    bash ~/debian_mate_de.sh
fi
clear
if [ ! -f /usr/local/bin/vncserver-start ]; then
    wget --tries=20  $dlink/Installer/DEs/MATE/vncserver-start -O /usr/local/bin/vncserver-start
    wget --tries=20 $dlink/Installer/DEs/MATE/vncserver-stop -O /usr/local/bin/vncserver-stop
