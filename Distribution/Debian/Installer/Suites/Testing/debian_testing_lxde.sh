...
wget --tries=20 $dlink/Installer/DEs/LXDE/debian_lxde_de.sh -O $folder/root/debian_lxde_de.sh
clear
...
echo " "
clear
if [ ! -f /root/debian_lxde_de.sh ]; then
    wget --tries=20 $dlink/Installer/DEs/LXDE/debian_lxde_de.sh -O /root/debian_lxde_de.sh
    bash ~/debian_lxde_de.sh
else
    bash ~/debian_lxde_de.sh
fi
clear
if [ ! -f /usr/local/bin/vncserver-start ]; then
    wget --tries=20  $dlink/Installer/DEs/LXDE/vncserver-start -O /usr/local/bin/vncserver-start
...
echo ' Welcome to Mobilinux | Debian Testing (byllseye)'
rm -rf /root/adduser.sh
rm -rf /root/debian_lxde_de.sh
