...
then
        ...
        then
            	echo 'Installing Full System '
		          sleep 4
		          apt-get install lxqt-core openbox lxqt-config qterminal tigervnc-standalone-server dbus-x11 xfe gimp neofetch libreoffice lubuntu-desktop -y
...
mkdir ~/.vnc
wget https://raw.githubusercontent.com/MobilinuxApp/Mobiconsole-CLI/master/Distribution/Ubuntu/Installer/DEs/LXQT/xstartup -P ~/.vnc/
wget https://raw.githubusercontent.com/MobilinuxApp/Mobiconsole-CLI/master/Distribution/Ubuntu/Installer/DEs/LXQT/vncserver-start -P /usr/local/bin/
wget https://raw.githubusercontent.com/MobilinuxApp/Mobiconsole-CLI/master/Distribution/Ubuntu/Installer/DEs/LXQT/vncserver-stop -P /usr/local/bin/
