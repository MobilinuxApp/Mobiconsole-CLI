...
then
		...
		sleep 4
    		apt-get install lxqt-core lxqt-config qterminal tightvncserver dbus-x11 xfe -y
        fi
		...
		sleep 4
		apt-get install lxqt-core lxqt-config qterminal tightvncserver dbus-x11 lubuntu-desktop xfe gimp neofetch libreoffice -y
