...
then
		...
		sleep 4
    		apt-get install lxqt-core lxqt-config qterminal tightvncserver dbus-x11 xfe openbox -y
        fi
		...
		sleep 4
		apt-get install lxqt-core lxqt-config qterminal tightvncserver dbus-x11 lubuntu-desktop xfe gimp openbox neofetch libreoffice -y
...
mkdir ~/.vnc
wget https://raw.githubusercontent.com/MobilinuxApp/Mobiconsole-CLI/master/Distribution/Ubuntu/Installer/DEs/LXDE/xstartup -P ~/.vnc/
wget https://raw.githubusercontent.com/MobilinuxApp/Mobiconsole-CLI/master/Distribution/Ubuntu/Installer/DEs/LXDE/CompatabilityScripts/vncserver-start -P /usr/local/bin/
wget https://raw.githubusercontent.com/MobilinuxApp/Mobiconsole-CLI/master/Distribution/Ubuntu/Installer/DEs/LXDE/vncserver-stop -P /usr/local/bin/
