...
then
        ...
        then
            	echo 'Installing Full System '
		          sleep 4
		          apt-get install lxde-core lxterminal tigervnc-standalone-server ubuntu-desktop lxde xfe gimp neofetch libreoffice -y
...
wget https://raw.githubusercontent.com/MobilinuxApp/Mobiconsole-CLI/master/Distribution/Ubuntu/Installer/DEs/LXDE/vncserver-start -P /usr/local/bin/
