...
[ ! -f /root/.parrot ] && apt-get update && apt upgrade || echo "Parrot detected, not updating apt cache since that will break the whole distro"
apt install dialog
clear
trap '' 2
...
then
		...
		sleep 4
    		apt-get install xfce4 xfce4-terminal tightvncserver xfe -y
        fi
		...
		sleep 4
		apt-get install xfe xfce4 xfce4-terminal tightvncserver xfce4-goodies gimp neofetch libreoffice xubuntu-desktop -y
...
mkdir ~/.vnc
wget https://raw.githubusercontent.com/MobilinuxApp/Mobiconsole-CLI/master/Distribution/Ubuntu/Installer/DEs/XFCE4/xstartup -P ~/.vnc/
wget https://raw.githubusercontent.com/MobilinuxApp/Mobiconsole-CLI/master/Distribution/Ubuntu/Installer/DEs/XFCE4/vncserver-start -P /usr/local/bin/
wget https://raw.githubusercontent.com/MobilinuxApp/Mobiconsole-CLI/master/Distribution/Ubuntu/Installer/DEs/XFCE4/vncserver-stop -P /usr/local/bin/
