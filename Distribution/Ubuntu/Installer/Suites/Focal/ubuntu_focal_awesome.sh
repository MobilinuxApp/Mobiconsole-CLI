...
wget --tries=20 $dlink/Installer/WindowManager/Awesome/ubuntu_awesome_wm_patch.sh -O $folder/root/ubuntu_awesome_wm_patch.sh
...
clear
if [ ! -f /root/ubuntu_awesome_wm_patch.sh ]; then
    wget --tries=20 $dlink/Installer/WindowManager/Awesome/ubuntu_awesome_wm_patch.sh -O /root/ubuntu_awesome_wm_patch.sh
    bash ~/ubuntu_awesome_wm_patch.sh
else
    bash ~/ubuntu_awesome_wm_patch.sh
fi
clear
if [ ! -f /usr/local/bin/vncserver-start ]; then
    wget --tries=20  $dlink/Installer/WindowManager/Awesome/vncserver-start -O /usr/local/bin/vncserver-start 
    wget --tries=20 $dlink/Installer/WindowManager/Awesome/vncserver-stop -O /usr/local/bin/vncserver-stop
...
rm -rf /root/ubuntu_awesome_wm_patch.sh
