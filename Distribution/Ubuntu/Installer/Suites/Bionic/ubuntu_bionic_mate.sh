...
wget --tries=20 $dlink/Installer/DEs/MATE/ubuntu_mate_de.sh -O $folder/root/ubuntu_mate_de.sh
clear
...
clear
if [ ! -f /root/ubuntu_mate_de.sh ]; then
    wget --tries=20 $dlink/Installer/DEs/MATE/ubuntu_mate_de.sh -O /root/ubuntu_mate_de.sh
    bash ~/ubuntu_mate_de.sh
else
    bash ~/ubuntu_mate_de.sh
