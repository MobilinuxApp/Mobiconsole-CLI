...
wget --tries=20 $dlink/Installer/DEs/LXQT/ubuntu_lxqt_de.sh -O $folder/root/ubuntu_lxqt_de.sh
clear
...
clear
if [ ! -f /root/ubuntu_lxqt_de.sh ]; then
    wget --tries=20 $dlink/Installer/DEs/LXQT/ubuntu_lxqt_de.sh -O /root/ubuntu_lxqt_de.sh
    bash ~/ubuntu_lxqt_de.sh
else
    bash ~/ubuntu_lxqt_de.sh
fi
clear
