...
wget --tries=20 $dlink/Installer/DEs/LXDE/ubuntu_lxde_de.sh -O $folder/root/ubuntu_lxde_de.sh
clear
...
clear
if [ ! -f /root/ubuntu_lxde_de.sh ]; then
    wget --tries=20 $dlink/Installer/DEs/LXDE/ubuntu_lxde_de.sh -O /root/ubuntu_lxde_de.sh
    bash ~/ubuntu_lxde_de.sh
else
    bash ~/ubuntu_lxde_de.sh
fi
clear
