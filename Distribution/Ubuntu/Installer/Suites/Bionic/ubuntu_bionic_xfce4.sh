...
wget --tries=20 $dlink/Installer/DEs/XFCE4/ubuntu_xfce4_de.sh -O $folder/root/ubuntu_xfce4_de.sh
clear
...
clear
if [ ! -f /root/ubuntu_xfce4_de.sh ]; then
    wget --tries=20 $dlink/Installer/DEs/XFCE4/ubuntu_xfce4_de.sh -O /root/ubuntu_xfce4_de.sh
    bash ~/ubuntu_xfce4_de.sh
else
    bash ~/ubuntu_xfce4_de.sh
