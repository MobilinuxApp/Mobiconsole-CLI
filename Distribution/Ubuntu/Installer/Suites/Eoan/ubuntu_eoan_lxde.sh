...
wget --tries=20 $dlink/Installer/DEs/LXDE/ubuntu_lxde_de_patch.sh -O $folder/root/ubuntu_lxde_de_patch.sh
clear
...
if [ ! -f /root/ubuntu_lxde_de_patch.sh ]; then
    wget --tries=20 $dlink/Installer/DEs/LXDE/ubuntu_lxde_de_patch.sh -O /root/ubuntu_lxde_de_patch.sh
    bash ~/ubuntu_lxde_de_patch.sh
else
    bash ~/ubuntu_lxde_de_patch.sh
fi
clear
...
rm -rf /root/ubuntu_lxde_de_patch.sh
