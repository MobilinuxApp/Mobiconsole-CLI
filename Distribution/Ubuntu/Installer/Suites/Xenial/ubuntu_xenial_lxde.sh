...
wget --tries=20 $dlink/Installer/DEs/LXDE/CompatabilityScripts/ubuntu-compact-lxde.sh -O $folder/root/ubuntu-compact-lxde.sh
clear
...
clear
if [ ! -f /root/ubuntu-compact-lxde.sh ]; then
    wget --tries=20 $dlink/Installer/DEs/LXDE/CompatabilityScripts/ubuntu-compact-lxde.sh -O /root/ubuntu-compact-lxde.sh
    bash ~/ubuntu-compact-lxde.sh
else
    bash ~/ubuntu-compact-lxde.sh
fi
clear
