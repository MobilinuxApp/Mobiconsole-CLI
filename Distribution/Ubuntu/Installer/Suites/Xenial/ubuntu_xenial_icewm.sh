...
wget --tries=20 $dlink/Installer/WindowManager/IceWM/ubuntu_icewm_wm.sh -O $folder/root/ubuntu_icewm_wm.sh
clear
...
clear
if [ ! -f /root/ubuntu_icewm_wm.sh ]; then
    wget --tries=20 $dlink/Installer/WindowManager/IceWM/ubuntu_icewm_wm.sh -O /root/ubuntu_icewm_wm.sh
    bash ~/ubuntu_icewm_wm.sh
else
    bash ~/ubuntu_icewm_wm.sh
fi
clear
