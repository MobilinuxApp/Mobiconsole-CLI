...
wget --tries=20 $dlink/Installer/DEs/MATE/CompatabilityScripts/ubuntu-compact-mate.sh -O $folder/root/ubuntu-compact-mate.sh
clear
...
clear
if [ ! -f /root/ubuntu-compact-mate.sh ]; then
    wget --tries=20 $dlink/Installer/DEs/MATE/CompatabilityScripts/ubuntu-compact-mate.sh -O /root/ubuntu-compact-mate.sh
...
rm -rf /root/ubuntu-compact-mate.sh
