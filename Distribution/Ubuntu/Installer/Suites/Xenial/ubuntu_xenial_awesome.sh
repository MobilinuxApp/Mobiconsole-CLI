...
wget --tries=20 $dlink/Installer/WindowManager/Awesome/ubuntu_awesome_wm.sh -O $folder/root/ubuntu_awesome_wm.sh
clear
...
clear
if [ ! -f /root/ubuntu_awesome_wm.sh ]; then
    wget --tries=20 $dlink/Installer/WindowManager/Awesome/ubuntu_awesome_wm.sh -O /root/ubuntu_awesome_wm.sh
    bash ~/ubuntu_awesome_wm.sh
else
    bash ~/ubuntu_awesome_wm.sh
fi
clear
...
rm -rf /root/ubuntu_awesome_wm.sh
