...
wget --tries=20 $dlink/Installer/DEs/XFCE4/ubuntu_xfce4_de_patch.sh -O $folder/root/ubuntu_xfce4_de_patch.sh
...
clear
if [ ! -f /root/ubuntu_xfce4_de_patch.sh ]; then
    wget --tries=20 $dlink/Installer/DEs/XFCE4/ubuntu_xfce4_de_patch.sh -O /root/ubuntu_xfce4_de_patch.sh
    bash ~/ubuntu_xfce4_de_patch.sh
else
    bash ~/ubuntu_xfce4_de_patch.sh
fi
clear
