...
wget --tries=20 $dlink/Installer/DEs/XFCE4/void_xfce4_de.sh -O $folder/root/void_xfce4_de.sh > /dev/null
clear
...
if [ ! -f /root/void_xfce4_de.sh ]; then
    wget --tries=20 $dlink/Installer/DEs/XFCE4/void_xfce4_de.sh -O /root/void_xfce4_de.sh > /dev/null
    bash ~/void_xfce4_de.sh 
else
    bash ~/void_xfce4_de.sh
fi
clear
if [ ! -f /usr/local/bin/vncserver-start ]; then
    wget --tries=20  $dlink/Installer/DEs/XFCE4/vncserver-start -O /usr/local/bin/vncserver-start > /dev/null
    wget --tries=20 $dlink/Installer/DEs/XFCE4/vncserver-stop -O /usr/local/bin/vncserver-stop > /dev/null
