...
if [ -d $folder/var ];then
	...
	rm -rf $folder/root/.bash_profile
  	echo "#!/bin/bash
              wget https://raw.githubusercontent.com/MobilinuxApp/Mobiconsole-CLI/master/Distribution/Alpine/Installer/DEs/MATE/alpine_mate_de.sh -O /root/alpine_mate_de.sh
              bash /root/alpine_mate_de.sh
              rm -rf /root/alpine_mate_de.sh
              clear
