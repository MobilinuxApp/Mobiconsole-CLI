...
echo ""
[ ! -f /root/.vnc/passwd ] && echo "No previous VNC password found. Setting mobilinux as default password!" && mkdir -p /root/.vnc && x11vnc -storepasswd mobilinux /root/.vnc/passwd || echo "Previously generated password found. Keeping your old password"
echo ""
