...
then
        ...
        then
            	echo 'Installing Full System '
		          sleep 4
		          yum install awesome tigervnc-server --forcearch=armv7hl -y  
              dnf install neofetch gimp libreoffice --forcearch=armv7hl -y 
...
mkdir ~/.vnc
wget https://raw.githubusercontent.com/MobilinuxApp/Mobiconsole-CLI/master/Distribution/Fedora/Installer/WindowManager/arm/Awesome/xstartup -P ~/.vnc/
wget https://raw.githubusercontent.com/MobilinuxApp/Mobiconsole-CLI/master/Distribution/Fedora/Installer/WindowManager/arm/Awesome/vncserver-start -P /usr/local/bin/
wget https://raw.githubusercontent.com/MobilinuxApp/Mobiconsole-CLI/master/Distribution/Fedora/Installer/WindowManager/arm/Awesome/vncserver-stop -P /usr/local/bin/
