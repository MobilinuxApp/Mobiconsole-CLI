...
wget --tries=20 $dlink/Installer/DEs/LXDE/backbox_lxde_de.sh -O $folder/root/backbox_lxde_de.sh
clear
...
clear
if [ ! -f /root/backbox_lxde_de.sh ]; then
    wget --tries=20 $dlink/Installer/DEs/LXDE/backbox_lxde_de.sh -O /root/backbox_lxde_de.sh
    bash ~/backbox_lxde_de.sh
else
    bash ~/backbox_lxde_de.sh
fi
clear
