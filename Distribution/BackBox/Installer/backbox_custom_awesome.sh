...
wget --tries=20 $dlink/Installer/WindowManagers/Awesome/backbox_awesome_wm.sh -O $folder/root/backbox_awesome_wm.sh
clear
...
rm -rf /root/backbox_awesome_wm.sh
