...
wget --tries=20 $dlink/Installer/WindowManagers/IceWM/backbox_icewm_wm.sh -O $folder/root/backbox_icewm_wm.sh
clear
...
clear
if [ ! -f /root/backbox_icewm_wm.sh ]; then
    wget --tries=20 $dlink/Installer/WindowManagers/IceWM/backbox_icewm_wm.sh -O /root/backbox_icewm_wm.sh
    bash ~/backbox_icewm_wm.sh
else
    bash ~/backbox_icewm_wm.sh
fi
clear
...
rm -rf /root/backbox_icewm_wm.sh
