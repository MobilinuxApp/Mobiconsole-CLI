...
wget --tries=20 $dlink/Installer/DEs/MATE/backbox_mate_de.sh -O $folder/root/backbox_mate_de.sh
clear
...
clear
if [ ! -f /root/backbox_mate_de.sh ]; then
    wget --tries=20 $dlink/Installer/DEs/MATE/backbox_mate_de.sh -O /root/backbox_mate_de.sh
    bash ~/backbox_mate_de.sh
else
    bash ~/backbox_mate_de.sh
fi
clear
