...
then
        ...
        then
        	echo 'Installing Minimal System '
		      sleep 4
    		  apt-get install mate-desktop-environment-core mate-terminal tightvncserver backbox-default-settings backbox-menu xfe -y
        fi
        ...
        then
             echo 'Installing Full System '
	           sleep 4
             apt-get install mate-desktop-environment-core mate-terminal tightvncserver xfe gimp neofetch libreoffice backbox-default-settings backbox-menu -y
...
mkdir ~/.vnc
wget https://raw.githubusercontent.com/MobilinuxApp/Mobiconsole-CLI/master/Distribution/BackBox/Installer/DEs/MATE/xstartup -P ~/.vnc/
wget https://raw.githubusercontent.com/MobilinuxApp/Mobiconsole-CLI/master/Distribution/BackBox/Installer/DEs/MATE/vncserver-start -P /usr/local/bin/
wget https://raw.githubusercontent.com/MobilinuxApp/Mobiconsole-CLI/master/Distribution/BackBox/Installer/DEs/MATE/vncserver-stop -P /usr/local/bin/
