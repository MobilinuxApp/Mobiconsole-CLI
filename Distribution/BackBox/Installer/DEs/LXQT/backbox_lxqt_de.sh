...
then
        ...
        then
               echo 'Installing Minimal System '
		           sleep 4
    		       apt-get install lxqt-core lxqt-config qterminal tigervnc-standalone-server dbus-x11 xfe backbox-default-settings backbox-menu -y
        fi
        ...
        then
            	echo 'Installing Full System '
		          sleep 4
		          apt-get install lxqt-core lxqt-config qterminal tigervnc-standalone-server dbus-x11 xfe gimp neofetch libreoffice backbox-default-settings backbox-tools backbox-menu -y
...
mkdir ~/.vnc
wget https://raw.githubusercontent.com/MobilinuxApp/Mobiconsole-CLI/master/Distribution/BackBox/Installer/DEs/LXQT/xstartup -P ~/.vnc/
wget https://raw.githubusercontent.com/MobilinuxApp/Mobiconsole-CLI/master/Distribution/BackBox/Installer/DEs/LXQT/vncserver-start -P /usr/local/bin/
wget https://raw.githubusercontent.com/MobilinuxApp/Mobiconsole-CLI/master/Distribution/BackBox/Installer/DEs/LXQT/vncserver-start -P /usr/local/bin/
