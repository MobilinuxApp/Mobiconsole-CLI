...
then
        ...
        then
                echo 'Installing Minimal System '
		            sleep 4
    		        apt-get install lxde-core lxterminal tigervnc-standalone-server backbox-default-settings backbox-menu xfe -y
        fi
        ...
        then
            	echo 'Installing Full System '
		          sleep 4
		          apt-get install lxde-core lxterminal tigervnc-standalone-server task-lxde-desktop lxde xfe gimp neofetch libreoffice backbox-default-settings backbox-menu backbox-tools -y
...
mkdir ~/.vnc
wget https://raw.githubusercontent.com/MobilinuxApp/Mobiconsole-CLI/master/Distribution/BackBox/Installer/DEs/LXDE/xstartup -P ~/.vnc/
wget https://raw.githubusercontent.com/MobilinuxApp/Mobiconsole-CLI/master/Distribution/BackBox/Installer/DEs/LXDE/vncserver-start -P /usr/local/bin/
wget https://raw.githubusercontent.com/MobilinuxApp/Mobiconsole-CLI/master/Distribution/BackBox/Installer/DEs/LXDE/vncserver-stop -P /usr/local/bin/
